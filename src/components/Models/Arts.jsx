...
export function Arts(props) {
  ...
  return (
    <group {...props} dispose={null} position={[0, -1.5, 0]} scale={0.5}>
      ...
      <mesh geometry={nodes.videoboard.geometry} material={materials['Material.001']} position={[0, 4.427, 0.215]} rotation={[0, 0.003, 0]} scale={[4.045, 2.608, 0.137]} />
